...
quant_sim = QuantizationSimModel(prepared_model, dummy_input=dummy_input,
                                    ...
                                    config_file='/home/anaconda3/envs/aimet_py1.20/lib/python3.6/site-packages/aimet_common/quantsim_config/htp_quantsim_config.json')

quant_sim.compute_encodings(model_eval("/home/rayari/5000/", image_size = (1,3,224,224), batch_size=64, num_workers=16, model_name='PTQ model'), (1, True))
